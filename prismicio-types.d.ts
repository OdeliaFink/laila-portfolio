...
/**
 * Item in *PortfolioIndex → Default → Primary → Image Gallery*
 */
export interface PortfolioIndexSliceDefaultPrimaryImageGalleryItem {
  /**
   * Images field in *PortfolioIndex → Default → Primary → Image Gallery*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: portfolio_index.default.primary.image_gallery[].images
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  images: prismic.ImageField<never>;

  /**
   * Category_name field in *PortfolioIndex → Default → Primary → Image Gallery*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: portfolio_index.default.primary.image_gallery[].category_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  category_name: prismic.KeyTextField;

  /**
   * Hyperlink Image field in *PortfolioIndex → Default → Primary → Image Gallery*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: portfolio_index.default.primary.image_gallery[].hyperlink_image
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  hyperlink_image: prismic.LinkField;
}

/**
 * Item in *PortfolioIndex → Default → Primary → Categories*
 */
export interface PortfolioIndexSliceDefaultPrimaryCategoriesItem {
  /**
   * Category Name field in *PortfolioIndex → Default → Primary → Categories*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: portfolio_index.default.primary.categories[].category_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  category_name: prismic.KeyTextField;
}
...
/**
 * Primary content in *PortfolioIndex → Default → Primary*
 */
export interface PortfolioIndexSliceDefaultPrimary {
  /**
   * Image Gallery field in *PortfolioIndex → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: portfolio_index.default.primary.image_gallery[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  image_gallery: prismic.GroupField<
    Simplify<PortfolioIndexSliceDefaultPrimaryImageGalleryItem>
  >;

  /**
   * Categories field in *PortfolioIndex → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: portfolio_index.default.primary.categories[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  categories: prismic.GroupField<
    Simplify<PortfolioIndexSliceDefaultPrimaryCategoriesItem>
  >;
}

/**
 * Default variation for PortfolioIndex Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type PortfolioIndexSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<PortfolioIndexSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *PortfolioIndex*
 */
type PortfolioIndexSliceVariation = PortfolioIndexSliceDefault;

/**
 * PortfolioIndex Shared Slice
 *
 * - **API ID**: `portfolio_index`
 * - **Description**: PortfolioIndex
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type PortfolioIndexSlice = prismic.SharedSlice<
  "portfolio_index",
  PortfolioIndexSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      PortfolioIndexSlice,
      PortfolioIndexSliceDefaultPrimaryImageGalleryItem,
      PortfolioIndexSliceDefaultPrimaryCategoriesItem,
      PortfolioIndexSliceDefaultPrimary,
      PortfolioIndexSliceVariation,
      PortfolioIndexSliceDefault,
      TextWithFeaturesSlice,
